		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices list",
									"targetURL": "#perceptioacademyinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"perceptioacademyinvoices-display": {
								"semanticObject": "perceptioacademyinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=perceptioacademy.invoices",
									"url": sap.ui.require.toUrl("perceptioacademy/invoices")
								}
							}
						}
					}
